    ...
    public class ImageStreamingServer:IDisposable
    {
        ...
        private void ServerThread(object state)
        {
            ...
            try
            {
                ...
                //if we want to work with udp then we will change the SocketType to Dgram instead of stream and the ProtocolType to udp instead of tcp
                //but we will NOT able to test the udp in localhost like we are doing in the next lines
